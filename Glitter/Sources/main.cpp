...
int main(int argc, char * argv[]) {
	...
	std::string texture1path = GlitterPathConfig::path_res_textures + "container.jpg";
    std::string texture2path = GlitterPathConfig::path_res_textures +  "awesomeface.png";
